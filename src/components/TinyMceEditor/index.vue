...
const props = withDefaults(defineProps<Props>(), {
  ...
  toolbar:
    'undo redo | blocks fontfamily | bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | outdent indent | numlist bullist | forecolor backcolor | link image media | code | removeformat',
})
...
const editorConfig = computed(() => {
  ...
  return {
    ...
    image_list: [{ title: '图片1', value: 'https://www.example.com/image1.jpg' }],
    image_class_list: [
      { title: 'None', value: '' },
